...
<!--Search End-->
    ...
    // Connect to database to get username
    $host="localhost";
    $dbusername = "root";
    $dbpassword = "";
    $dbname = "alb";
    ...
    $sql = "SELECT CONCAT(firstname, ' ', lastname) as fullname FROM users WHERE users_id='$users_id'";
  ...
  <center><br><br><br>
                <div style="background-color: #f5f5f5; padding: 20px; border-radius: 8px; margin-bottom: 20px; width: 50%;">
                    <h3 style="color: #1a472a; margin: 0;">User to Delete: <?php echo $username; ?></h3>
                </div>
                <input type="hidden" name="users_id" value="<?php echo $users_id; ?>">
                <b class="d1"> Are you sure to delete this user?  </b><br><br>
