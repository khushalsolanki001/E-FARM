...
<!--Placeholder end-->
                ...
                <td></tr><tr><th>Category (Agri Inputs)</th><td>
                <input list="types" class="b2" name="types"  value=<?php echo $u4;?> placeholder="Select category (e.g., FERTILIZER)" required pattern="[A-Z]+" title="Capital Letters Only">
                <datalist id="types">
